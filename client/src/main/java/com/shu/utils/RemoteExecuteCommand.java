...
public class RemoteExecuteCommand {
    ...
    public static void main(String[] args) {
        RemoteExecuteCommand rec=new RemoteExecuteCommand("114.215.84.38", "root","wdnyhghyt");
        System.out.println("测试开始");
        //执行命令
        System.out.println(rec.execute("ifconfig"));
        //执行脚本
        rec.execute("ffmpeg -i \"rtmp://115.159.62.204:1935/qunima/live\" -f image2 -s 300*200 /liveImg/stream.jpg");
