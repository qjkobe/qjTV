                        ...
                        <div class="portlet box blue-hoki">
                            ...
                            <div class="portlet-body">
                                <table class="table table-striped table-bordered table-hover" id="sample_1">
                                    ...
                                    <c:if test="${followList != '0'}">
                                    <c:forEach items="${followList}" var="item" varStatus="st">
                                        <tr>
                                            <td id="${item.followid}name">
                                                <script>
                                                    $.ajax({
                                                        type: "POST",
                                                        url: "/index/getnick",
                                                        ...
                                                        success: function(data){
                                                            temp = eval(data);
                                                            if(temp.status == "success"){
                                                                $("#${item.followid}name").html(temp.nickname);
                                                            }
                                                        },
                                                        error: function(data){
                                                            alert("系统错误");
                                                ...
                                                <script>
                                                    $.ajax({
                                                        ...
                                                        success: function(data){
                                                            temp = eval(data);
                                                            if(temp.status == "success"){
                                                                $("#${item.followid}room").html(temp.roomNum);
                                                            }
                                                        },
                                                        error: function(data){
                                                            alert("系统错误");
                                                ...
                                                <script>
                                                    $.ajax({
                                                        ...
                                                        success: function(data){
                                                            ...
                                                            if(temp.status == "success"){
                                                                if(temp.kaibo == "Y"){
                                                                    $("#${item.followid}isLive").html("是");
                                                                }else{
                                                                    $("#${item.followid}isLive").html("否");
                                                                }
                                                            }
                                                        },
                                                        error: function(data){
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-danger quguan" data-id="${item.id}">取关</button>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    </c:if>
