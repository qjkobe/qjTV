...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <!-- BEGIN PAGE HEADER-->
            <h3 class="page-title">
                搜索直播 <small>我 & 你</small>
            </h3>
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    <li>
                        <i class="fa fa-home"></i>
                        <a href="index.html">搜索直播</a>
...
<c:if test="${liveroom != 'noresult'}">
                    <%--获得直播间，每获取四个，就增加一个li--%>
                        ...
                        <li class="col-md-3 col-sm-3 list-group-item">
                            <a href="/index/toRoom/${liveroom.roomnum}" title="点击进入直播间">
                                <img src="${ctx}/upload/cover/${liveroom.img}" width="330" height="210" alt="点击进入直播间">
                            </a>
                            <br><strong>标题: </strong>
                            <strong>${liveroom.title}</strong>

                            <br><strong>在线: </strong><strong id="${liveroom.roomnum}online">0</strong>
                            <script>
                                $.ajax({
                                    type: "POST",
                                    ...
                                    success: function(data){
                                        ...
                                        if(temp.status == "success"){
                                            $("#${liveroom.roomnum}online").html(temp.onlinenum);
                                        }
                                    },
                                    error: function(data){
                                        alert("系统错误");
            ...
            <div class="row">
                    <c:if test="${liveroom2 == 'noresult'}">
                        搜索不到相关直播间
                    </c:if>
                <ul class="list-group">
<c:if test="${liveroom2 != 'noresult'}">
                        <c:forEach items="${liveroom2}" var="item" varStatus="st">
            ...
            <div class="row">
                    <c:if test="${liveroom3 == 'noresult'}">
                        搜索不到相关直播间
                    </c:if>
                <ul class="list-group">
    <c:if test="${liveroom3 != 'noresult'}">
                        <c:forEach items="${liveroom3}" var="item" varStatus="st">
                            <c:if test="${st.count % 4==1}">
                            </c:if>
                            <li class="col-md-3 col-sm-3 list-group-item">
                                <a href="/index/toRoom/${item.roomnum}" title="点击进入直播间">
